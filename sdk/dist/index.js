...
class SentinelGuard {
    constructor(options) {
        this.options = Object.assign(Object.assign({}, options), { apiUrl: options.apiUrl || "http://localhost:8000" });
    }
    guard(message, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d;
            const timeoutMs = (_a = this.options.timeoutMs) !== null && _a !== void 0 ? _a : DEFAULT_TIMEOUT_MS;
            const controller = new AbortController();
            const timeoutId = setTimeout(() => controller.abort(), timeoutMs);
            try {
                const response = yield fetch(`${this.options.apiUrl.replace(/\/$/, '')}/analyze`, {
                    method: 'POST',
                    headers: {
